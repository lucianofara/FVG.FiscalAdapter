...
{
    public class OpenCommandPrintController : ApiController
    {
        ...
        [HttpPost]
        public async Task<Result> Post(OpenCommandDocument document) => await Task.Run<Result>(() => _processor.Print<OpenCommandDocument>(document));
    }
}